...
if __name__ == "__main__":
    ...
    log_path = "logs/train_log_taskb_v2.csv"
    ...
    for epoch in range(10):
        ...
        loop = tqdm(train_loader, desc=f"[TaskBv2] Epoch {epoch+1}/10")
        ...
        torch.save({"epoch": epoch+1, "state_dict": model.state_dict()}, f"logs/taskb_v2_epoch{epoch+1}.pth")
